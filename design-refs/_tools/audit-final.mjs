/**
 * Phase 4 final audit. Same harness as audit-current.mjs but writes to
 * design-refs/audit-final/ for side-by-side comparison against source-shots/.
 */
...
const OUT_DIR = path.resolve(__dirname, '..', 'audit-final')
