          ...
          <CardContent className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                maxLength={80}
              />
              <p className="text-xs text-muted-foreground">What readers see on the gate</p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="paywall-uri">Content URL</Label>
              <Input
                id="paywall-uri"
              ...
              <p className="text-xs text-muted-foreground">
                The URL that unlocks after purchase. Your server should check receipt on chain.
              </p>
            </div>

            <div className="space-y-2">
              <Label htmlFor="paywall-price">{`One-time price (${ORI_SYMBOL})`}</Label>
              <Input
                id="paywall-price"
                placeholder="0"
                inputMode="decimal"
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <Button asChild variant="secondary" size="lg">
                <Link href="/paywall/mine">My paywalls</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
